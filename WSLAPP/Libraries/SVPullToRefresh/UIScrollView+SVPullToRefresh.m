...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        CGSize maxSize = CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight);
        CGSize titleSize = [self.titleLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: self.titleLabel.font} context:nil].size;
...
//                                                      lineBreakMode:self.subtitleLabel.lineBreakMode];
        CGSize subtitleMaxSize = CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight);
        CGSize subtitleSize = [self.subtitleLabel.text boundingRectWithSize:subtitleMaxSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: self.subtitleLabel.font} context:nil].size;
